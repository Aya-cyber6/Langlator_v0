...
extern "C" {
    ...
    // If you change the order or add new parameters, make sure to update the default values in whisper.jni:
    ...
    struct whisper_full_params {
        ...
        bool print_realtime;    // print results from within whisper.jni (avoid it, use callback instead)
